...
class NewVisitorTest(FunctionalTest):
    ...
    def test_can_start_a_list_for_one_user(self):
        ...
        self.assertEqual(
            self.newitem_inputbox.get_attribute('placeholder'),
            'Enter a to-do item'
        )
        ...
        self.verify_todo_in_list('1: Buy peacock feathers')
        ...
        self.verify_todo_in_list('2: Use peacock feathers to make a fly')
        self.verify_todo_in_list('1: Buy peacock feathers')
